...
export const STEPS: Record<string, Step> = {
  ...
  [STEP_GUMS]: {
    ...
    options: [
      ...
      { key: "nocturia_gt1", label: "Встаёте ночью в туалет >1 раза" },
      { key: "stress_incontinence", label: "Подтекание мочи при кашле/смехе" },
      { key: "frequent_cystitis", label: "Частые циститы" },
      { key: "vulvar_discomfort", label: "Дискомфорт вульвы (зуд, жжение)" },
      { key: "nothing_selected", label: "Нет ничего из вышеуказанного" },
    ],
  ...
  [STEP_BODY]: {
    ...
    objectSchema: {
      ...
      diabetes: { kind: "boolean", label: "Сахарный диабет?" },
      physicalActivity: {
        kind: "select",
        label: "Физическая активность",
        options: [
          { key: "low", label: "Низкая (<150 мин/нед)" },
          { key: "moderate", label: "Умеренная (150–300 мин)" },
          { key: "high", label: "Высокая (тренировки)" },
        ],
      },
    },
  ...
  [STEP_CANCERS_1]: {
    ...
    options: [
      ...
      { key: "endometrial_cancer", label: "Рак эндометрия" },
  ...
  [STEP_ENDOMETRIOSIS]: {
    ...
    options: [
      ...
      { key: "infiltrative_endometriosis", label: "Инфильтративный эндометриоз" },
  ...
  [STEP_LIVER]: {
    ...
    answerType: "multi",
    options: [
      { key: "active_liver_disease", label: "Гепатит / цирроз / опухоли печени" },
      { key: "liver_mht_cancellation", label: "Отмена МГТ из-за печени в анамнезе" },
      { key: "nothing_selected", label: "Нет ничего из вышеуказанного" },
    ],
    helpText: "⚠️ Любой пункт — абсолютное противопоказание.",
    sensitive: true,
  ...
  [STEP_RISKS_1]: {
    ...
    options: [
      ...
      { key: "thrombophilia", label: "Тромбофилия (высокий риск)" },
      { key: "myoma_no_submucosal", label: "Миома матки (не субмукозная)" },
      { key: "adenomyosis", label: "Эндометриоз матки (аденомиоз)" },
      { key: "endometriosis_surgery_history", label: "Операции по эндометриозу" },
      { key: "elevated_bp", label: "Повышенное артериальное давление" },
      { key: "hypertension", label: "Гипертоническая болезнь" },
      { key: "bp_medication", label: "Принимаю препараты для ↓ АД" },
      { key: "ibd", label: "Заболевания кишечника" },
      { key: "nothing_selected", label: "Нет ничего из вышеуказанного" },
    ],
  },
  [STEP_ONCO_MONITORING]: {
    ...
    options: [
      ...
      { key: "skin_basal_cell", label: "Базалиома / рак кожи" },
      { key: "melanoma_local", label: "Меланома кожи (локальная)" },
      { key: "hematologic", label: "Лимфома / лейкемия" },
  ...
  [STEP_ONCO_NEGATIVE]: {
    ...
    options: [
      ...
      { key: "melanoma_metastatic", label: "Метастатическая меланома" },
  ...
  [STEP_LIPID]: {
    ...
    answerType: "multi",
    options: [
      { key: "high_cholesterol", label: "Общий холестерин" },
      { key: "high_ldl", label: "ЛПНП (плохой холестерин)" },
      { key: "high_triglycerides", label: "Триглицериды" },
      { key: "nothing_selected", label: "Нет ничего из вышеуказанного" },
    ],
  },
  [STEP_VARICOSE]: {
    ...
    answerType: "multi",
    options: [
      { key: "varicose", label: "Варикозная болезнь вен" },
      { key: "thrombophlebitis_history", label: "Тромбофлебит в анамнезе" },
      { key: "varicose_surgery", label: "Операции по варикозной болезни" },
      { key: "nothing_selected", label: "Нет ничего из вышеуказанного" },
    ],
  },
  [STEP_FOLLOWUP]: {
